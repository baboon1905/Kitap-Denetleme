...
def _normalize_payload(payload: dict) -> dict:
    ...
    # remove transient runtime fields that may differ between runs
...
def run_for_book(title: str):
    ...
    results = {}
    # first call analiz to get analiz_sonucu
    ...
    # check shadow presence and narrative keys when true
...
if __name__ == '__main__':
    ...
    # also run overall regression test using existing harness
    ...
    outpath = os.path.join(os.path.dirname(__file__), "phase4a_narrative_graph_verification.json")
