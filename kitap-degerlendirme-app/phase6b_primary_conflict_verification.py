...
def run_for_book(title: str):
    ...
    primary_conflict = narrative.get('primary_conflict') if isinstance(narrative, dict) else None
    resolution = narrative.get('resolution') if isinstance(narrative, dict) else None
    ...
    return {
        ...
        'shadow_only_check': {
            ...
            'shadow_includes_primary_conflict': isinstance(primary_conflict, dict),
            'shadow_includes_resolution': isinstance(resolution, dict),
        },
...
if __name__ == '__main__':
    ...
    outpath = os.path.join(os.path.dirname(__file__), 'phase6b_primary_conflict_verification.json')
