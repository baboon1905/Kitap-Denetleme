...
# -*- coding: utf-8 -*-
"""
Test: "vur" ve "gökkuşağı" kelimelerinin tespit edilmesi
"""
...
# Test metni - kitapta "vur" ve "gökkuşağı" kelimelerini içeren cümle
test_metin = """
Çocuk vurmaya başladı. Yumruğuyla masayı vurdu. 

Gökkuşağı rengindeki kuşlar ağaçta oturuyordu. 
Bahçede bir gökkuşağı var mı?
"""
...
print("\n" + "="*60)
print("TEST SONUÇLARI: 'vur' ve 'gökkuşağı' Tespiti")
print("="*60)
...
for kategori_adi, kategori_bulgular in sonuc["kategori_bulgulari"].items():
    if kategori_bulgular["bulundu"]:
        ...
        for bulgu in kategori_bulgular['bulunan_kelimeler']:
            print(f"   - '{bulgu['kelime']}' (Risk: {bulgu['baglamsal_risk']}/5) - Sayfa {bulgu['sayfa']}")
